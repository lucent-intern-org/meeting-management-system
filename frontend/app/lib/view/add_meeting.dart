import 'package:app/view_model/add_meeting_view_model.dart';
import 'package:app/widget_style.dart';
import 'package:dropdown_button2/dropdown_button2.dart';
import 'package:flutter/material.dart';

class AddMeeting extends StatefulWidget {
  AddMeeting({Key? key, required this.date, required this.timeindex, this.room})
      : super(key: key);
  final String date;
  final int timeindex;
  String? room;
  @override
  State<AddMeeting> createState() => _AddMeetingState(date, timeindex, room);
}

class _AddMeetingState extends State<AddMeeting> {
  _AddMeetingState(this.date, this.timeindex, this.room);

  AddMeetingViewModel addMettingViewModel = AddMeetingViewModel();
  ...
  void initState() {
    ...
    addMettingViewModel.addMeetingModel.date = date.substring(0, 10);
    addMettingViewModel.initFormModel().then((value) {
      setState(() {});
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    if (addMettingViewModel.addMeetingModel.groupList == []) {
      return Scaffold();
    } else {
      if (room != null) {
        addMettingViewModel.addMeetingModel.room = room;
      }
                    ...
                    child: Row(
                        ...
                        children: [
                          ...
                          DropdownButton2(
                            ...
                            items: addMettingViewModel.addMeetingModel.groupList
                                .map((item) => DropdownMenuItem<String>(
                                      value: item,
                                      child: Text(
                                        item,
                            ...
                            dropdownMaxHeight: 200,
                            value: addMettingViewModel.addMeetingModel.group,
                            onChanged: (value) {
                              setState(() {
                                addMettingViewModel
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: DropdownButton2(
                              iconSize: 0,
                              items:
                                  addMettingViewModel.addMeetingModel.roomList
                                      .map((item) => DropdownMenuItem<String>(
                                            value: item,
                                            child: Text(
                                              item,
                        ...
                        ElevatedButton(
                            ...
                            onPressed: () {
                              if (addMettingViewModel.formKey.currentState!
                                  .validate()) {
                                addMettingViewModel.addMeeting().then(
